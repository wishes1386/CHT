(typeof window !== "undefined" ? window : globalThis).CHT_SOURCES = {
...
(typeof window !== "undefined" ? window : globalThis).CHT_DATA_META = {
  version: "1.1",
  reviewedAt: "2025-08-22",
  note: "以中華電信官網 2023–2025 年公開文件為準；原文摘錄節錄自官方 PDF 文件"
};

(typeof window !== "undefined" ? window : globalThis).CHT_POLICIES = [
  {
    id: "conflict-family",
    category: "利益衝突",
    ...
    quote: "董事、經理人及員工如因其個人、配偶、子女或具二親等以內親屬之利益（包括任職與本公司有直接競爭關係公司之利益），使得個人的客觀性可能受質疑時，應向其直接主管或本公司組織暨人才發展單位報告。",
  ...
  },
  {
    ...
    quote: "為避免利益衝突，禁止對董事、高階主管及其配偶、子女或具二親等以內親屬給予借貸或為保證；對其他人員給予借貸，應事先依本公司規定審閱及核准。",
  ...
  },
  {
    ...
    quote: "除事前取得本公司組織暨人才發展單位書面同意者外，任何人不得從事與本公司競業之行為。",
  ...
  },
  {
    ...
    quote: "董事、經理人及員工，有義務維護本公司之合法利益，非經本公司同意者，任何人不得利用本公司之財產、資訊或其職位以獲取私人利益。",
  ...
  },
  {
    ...
    quote: "不得直接或間接提供、承諾、要求或收受任何形式之不正當利益，藉以建立商業關係或影響商業交易行為。",
  ...
  },
  {
    ...
    quote: "本公司及本公司董事、經理人、員工、受任人與實質控制者，不得直接或間接提供或接受任何不合理禮物、款待或其他不正當利益，藉以建立商業關係或影響商業交易行為。",
  ...
  },
  {
    ...
    quote: "慈善捐贈或贊助決策應做成書面紀錄。慈善捐贈之對象應為慈善機構，不得為變相行賄。",
  ...
  },
  {
    ...
    quote: "本行為準則規範之「營業秘密」包含本公司內部規範之營業秘密及因業務或合作關係而知悉且負保密義務之資訊，除因法令規章規範或經本公司授權得揭露者外，董事、經理人及員工對於取得之營業秘密皆須保密。",
  ...
  },
  {
    ...
    quote: "除因法令規章規範或經本公司授權得揭露者外，董事、經理人及員工對於取得之營業秘密皆須保密。",
  ...
  },
  {
    ...
    quote: "本公司防範內線交易之適用對象，於實際知悉本公司有內部重大消息時，在該消息明確後，未公開前或公開後十八小時內，不得對本公司、轉投資事業或專案對象之股票、其他具有股權性質之有價證券或非股權性質之公司債，自行或以他人名義買入或賣出。",
  ...
  },
  {
    ...
    quote: "本公司內部人不得於年度財務報告公告前三十日，和每季財務報告公告前十五日之封閉期間交易其股票。",
  ...
  },
  {
    ...
    quote: "本公司防範內線交易之適用對象於參與或知悉本公司內部重大消息事項時皆應保守秘密，不得對外洩漏。「對外洩漏」，係指將該等消息洩露予其配偶、子女、未參與或未知悉該內部重大消息之員工及他人等。",
  ...
  },
  {
    ...
    quote: "任何交付律師、會計師、政府機關、審計機關或相關機關之文件，董事、經理人及員工皆不得故意製作（或使他人製作）不完整、誤導或虛偽之陳述。",
  ...
  },
  {
    ...
    quote: "關於任何進行中或可能發生之訴訟、政府調查之相關文件，不得毀損、擅改或偽造。如有發生訴訟或政府調查案件時，應諮詢內部法務單位意見，並遵照其指示辦理。",
  ...
  },
  {
    ...
    quote: "不得對客戶、供應商或主管機關人員就事實、契約條件或本公司之政策為不實之陳述。如不慎為之，須儘速與主管及內部法務單位諮商、更正。",
  ...
  },
  {
    ...
    quote: "不得與競爭廠商之代表從事以下不法商業行為：（一）合訂價格。（二）分配、分割市場或客戶。（三）聯合杯葛或拒絕與其他客戶、供應商或競爭廠商交易。（四）從事其他不合法之限制競爭行為。",
  ...
  },
  {
    ...
    quote: "除事前經內部法務單位或上級同意外，不得與競爭廠商之代表討論或交換具商業競爭敏感性之訊息。",
  ...
  },
  {
    ...
    quote: "不得因個人、他人使用目的或因其他不適當目的，使用、竊取或故意侵佔本公司資產（含營業秘密）或客戶資產。",
  ...
  },
  {
    ...
    quote: "我們禁止任何形式的騷擾。騷擾指某人的行為導致他人感到驚恐、畏懼或困擾，這類行為可能侵犯他人尊嚴，或為受侵犯對象營造不利的工作環境。",
  ...
  },
  {
    ...
    quote: "歧視指因種族、性別、性傾向、宗教信仰、年齡、政治傾向、國籍、出生地、身心障礙及其他受適用法規保護的任何狀況而遭受歧視、騷擾或不平等的待遇。",
  ...
  },
  {
    ...
    quote: "任何人以善意告知有關違背道德之虞、疑似違反證券法令或其他不當之行為，不會遭受任何形式的報復（或報復之威脅）。",
  ...
  },
  {
    ...
    quote: "內部人員如有虛報或惡意指控之情事，應依本公司從業人員獎懲標準予以懲處，情節重大者應予以終止勞動契約。",
  ...
  },
  {
    ...
    quote: "供應商於執行業務時，不得直接或間接提供、承諾、要求或收受任何形式之不正當利益，包括回扣、佣金、疏通費或透過其他途徑向客戶、代理商、承包商、供應商、公職人員或其他利害關係人提供或收受不正當利益，藉以建立商業關係或影響商業交易行為。",
  ...
  },
  {
    ...
    quote: "所有的業務來往應具透明度，並準確地記錄在供應商的帳簿和商業記錄上。不得偽造記錄或虛報供應鏈的狀況或慣例。",
  ...
  },
  {
    ...
    quote: "對於本公司期待供應商親自履約（包括契約或訂單）的事項，非經本公司同意，供應商不得轉包或令第三方代為履行。",
  ...
  },
  {
    ...
    quote: "禁止使用強逼、擔保（包括抵債）或用契約束縛的勞工、非自願或剝削性監獄勞工、奴役或販賣的人口。不得僱用任何未滿15歲、或未達強迫教育年齡、或該國家/地區最低職業年齡的勞工。除緊急或特殊情況，每週的工作時數不應超過60小時（包括加班）。",
  ...
  },
  {
    ...
    quote: "董事、經理人及員工於知悉，或從事任何可能違背本行為準則或相關法規之行為或活動時，應即刻將此情況報告本公司組織暨人才發展單位。",
  ...
  },
  {
    ...
    quote: "本公司人員於執行公司業務時，發現與其自身或其所代表之法人有利害衝突之情形，或可能使其自身、配偶、父母、子女或與其有利害關係人獲得不正當利益之情形，應將相關情事同時陳報直屬主管及本公司專責單位。",
    keywords: ["爸爸", "父親", "媽媽", "母親", "爸媽", "父母", "兒子", "女兒", "兒女", "子女", "親屬", "家人", "主管", "單位", "客網", "上班", "考核", "監督", "直屬"],
    requiredGroups: [
      ["爸爸", "父親", "媽媽", "母親", "爸媽", "父母", "兒子", "女兒", "兒女", "子女", "親屬", "家人"],
  ...
  },
  {
    ...
    quote: "提供或承諾之人與其無職務上利害關係者，應於收受之日起三個工作日內，陳報其直屬主管，必要時並知會本公司專責單位。",
  ...
  },
  {
    ...
    quote: "供應商與本公司員工不必要或過度頻繁的社交往來也可能構成利益衝突的疑慮或觀感。所以供應商與本公司人員的任何接觸必須謹守一般商業往來的分際。",
  ...
  },
  {
    ...
    quote: "本公司及本公司董事、經理人、受僱人、受任人與實質控制者，不得直接或間接提供或接受任何不合理禮物、款待或其他不正當利益，藉以建立商業關係或影響商業交易行為。",
  ...
  },
  {
    ...
    quote: "本公司之資產應受保護，並僅得基於本公司之合法商業目的善加使用之。除經公司經營階層許可外，本公司之資產，不論其係有形或無形，只能由經授權之員工或其指定人使用。",
  ...
  },
  {
    ...
    quote: "「對外洩漏」，係指參與或知悉本公司內部重大消息之人員，將該等消息洩露予其配偶、子女、未參與或未知悉該內部重大消息之員工及他人等。",
  ...
  },
  {
    ...
    quote: "經理人及員工如違反本行為準則，可能遭受終止勞動契約之懲罰，其主管未提報該行為者，亦同。",
  ...
  },
  {
    ...
    quote: "任何人以善意告知有關違背道德之虞、疑似違反證券法令或其他不當之行為，不會遭受任何形式的報復（或報復之威脅）。如任何人認為其因上述行為而遭受報復（或威脅或騷擾）時，即應向其直接主管或本公司組織暨人才發展單位報告。",
  ...
  },
  {
    ...
    quote: "本公司所有財務行為包括對於餽贈及交際費之核銷、會計過帳與分錄，皆應以足夠詳細之可信方式，允當表達並妥適記錄於本公司帳冊而供檢查時使用，不得以任何方式誤導事實、遺漏資訊、或竄改記錄。",
  ...
  },
  {
    ...
    quote: "遵循各國當地稅務法規要求，按規定期限誠實申報及完納稅負。關係人交易遵循經濟合作暨發展組織（OECD）公布之國際移轉訂價準則，不刻意將利潤移轉至低稅率國家。不進行不合法避稅或操作避稅天堂等規劃。",
